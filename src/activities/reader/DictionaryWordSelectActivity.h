...
//
// Highlight mode (BookOrbit highlights): the first Confirm drops an anchor on the word under
...
class DictionaryWordSelectActivity final : public Activity {
 ...
 private:
  ...
  static constexpr size_t HIGHLIGHT_TEXT_CAPACITY = 2048;  // BookOrbit's annotation text cap
